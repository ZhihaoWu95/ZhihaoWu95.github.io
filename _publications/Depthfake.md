...
permalink: /publication/Depthfake
excerpt: 'This paper introduce an attack that can spoof a 3D liveness detection in face authentication systems using only one single 2D photo.'
date: 2023-05-21
venue: 'IEEE symposium on security and privacy (S&P) 2023'
paperurl: 'https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10179429'
citation: 'Wu Z, Cheng Y, Yang J, et al. Depthfake: Spoofing 3d face authentication with a 2d photo[C]//2023 IEEE symposium on security and privacy (SP). IEEE, 2023: 917-933.'
---
